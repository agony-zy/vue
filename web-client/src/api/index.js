...
// 创建订单
export const createOrder = (user_id, goods_id) =>
  ajax(BASE_URL + "/api/order/create", { user_id, goods_id }, "POST")

// 请求用户订单
export const getOrderList = params => ajax(BASE_URL + "/api/order/list", params)

// 修改订单状态
export const updateOrderStatus = params =>
  ajax(BASE_URL + "/api/order/update_status", params, "POST")
